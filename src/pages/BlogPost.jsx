...
export default function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        <p className="text-gray-600">No encontramos este artículo.</p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <h1 className="text-2xl font-bold text-brand-dark mt-1 mb-6">{post.title}</h1>

      <div className="prose-sm text-gray-700 space-y-4">
        {paragraphs.map((p, i) => (
